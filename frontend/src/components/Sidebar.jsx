...
import { Home, Users, QrCode, Monitor, ClipboardList, AlertTriangle, History, ShieldAlert, Activity, PieChart } from 'lucide-react';
  ...
  const getNavLinks = () => {
    if (role === 'SUPERVISOR') {
      return [
        ...
        { to: '/empresa/estadisticas', icon: <PieChart className="w-5 h-5" />, label: 'Estadísticas' },
